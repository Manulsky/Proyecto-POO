...
public class YouWin extends JFrame implements ActionListener {
	...
	public YouWin()
	{
		...
		try
		{
			...
			menuVolver.setBounds(300,400,menuImagen.getIconWidth(),menuImagen.getIconHeight());
		...
		ImageIcon gimagen = new ImageIcon("./imagenes/YouWin.png");
		...
		System.out.println("YouWin Cargado");
	}
